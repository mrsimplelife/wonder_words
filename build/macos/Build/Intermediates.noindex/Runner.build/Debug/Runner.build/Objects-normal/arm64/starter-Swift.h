...
#ifndef STARTER_SWIFT_H
#define STARTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="starter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7starter11AppDelegate")
...
SWIFT_CLASS("_TtC7starter17MainFlutterWindow")
