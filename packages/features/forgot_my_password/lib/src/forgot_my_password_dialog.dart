...
class ForgotMyPasswordDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ForgotMyPasswordCubit>(
      create: (_) => ForgotMyPasswordCubit(userRepository: userRepository),
        ...
        if (state.submissionStatus == SubmissionStatus.success) {
          ScaffoldMessenger.of(context)
            ...
            ..showSnackBar(SnackBar(
              content: Text(l10n.emailRequestSuccessMessage),
          ...
          child: AlertDialog(
            ...
            actions: [
              ...
              if (isSubmissionInProgress)
                InProgressTextButton(label: l10n.confirmButtonLabel)
              else
                TextButton(
