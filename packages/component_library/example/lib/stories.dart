  ...
  return [
    ...
    Story(
      ...
      builder: (_, k) => ExpandedElevatedButton(
        ...
        icon: Icon(
          k.options(label: 'icon', initial: Icons.home, options: const [
    ...
    Story(
      ...
      builder: (_, k) => RoundedChoiceChip(
        ...
        backgroundColor:
            k.options(label: 'backgroundColor', initial: null, options: const [
    ...
    Story.simple(
      name: 'Row App Bar',
      child: const RowAppBar(children: [
    ...
    Story(
      ...
      builder: (_, k) => SafeArea(
        child: ShrinkableText(
          ...
          textAlign:
              k.options(label: 'textAlign', initial: null, options: const [
